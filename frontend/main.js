...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (globeCanvas) {
    ...
    function resizeGlobe() {
      ...
      W = globeCanvas.offsetWidth;
      H = globeCanvas.offsetHeight;
    ...
    function drawGlobe() {
      ...
      for (const p of points) {
        ...
        ctx.fillStyle =
          `rgba(201,162,39,${0.12 + flicker * 0.55})`;
  ...
  if (pinCanvas) {
    ...
    function resizePins() {
      ...
      W = pinCanvas.offsetWidth;
      H = pinCanvas.offsetHeight;

      pinCanvas.width = W * dpr;
      pinCanvas.height = H * dpr;
    ...
    const jobPins = [

      {
        x: 0.22,
        y: 0.3,
        label: '2027 Graduate — CommBank'
      },

      {
        x: 0.5,
        y: 0.22,
        label: '2027 Graduate — KPMG'
      },

      {
        x: 0.62,
        y: 0.4,
        label: '2027 Graduate — EY'
      },

      {
        x: 0.82,
        y: 0.68,
        label: '2027 Graduate — QBE'
      },

      {
        x: 0.35,
        y: 0.6,
        label: 'Legal Intern — UN OLA'
      }
    ...
    const scholarPins = [

      {
        x: 0.44,
        y: 0.28,
        label: 'Rhodes Scholarship — Oxford'
      },

      {
        x: 0.2,
        y: 0.34,
        label: 'Fulbright — United States'
      },
  ...
  if (signinForm) {
    ...
    signinForm.addEventListener(
      ...
      async (e) => {
        ...
        alert(
          'Your account creation is connected. Sign in will be connected next.'
        );
